...
void sort_pairs(void)
{
    for (int i = 0; i < pair_count-1; i++)
    {
        ...
        {
            if(get_difference(pairs[j]) > get_difference(pairs[j+1]))
            {
...
void lock_pairs(void)
{
    ...
    for (int i = 0; i < pair_count; i++)
    {
        ...
        //intitialy setting condition to true
        condition = true;
...
//getting the difference of the winner and loser
int get_difference (pair p)
{
